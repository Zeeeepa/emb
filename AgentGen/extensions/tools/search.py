...
from agentgen.extensions.tools.tool_output_types import SearchArtifacts
from agentgen.extensions.tools.tool_output_types import SearchMatch as SearchMatchDict
