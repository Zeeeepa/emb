"""Implementation of a codebase inspector agent with MCP server."""
import os
...
def query_codebase(
    ...
    Args:
        query: A question or prompt requesting information about the codebase
        codebase_dir: Absolute path to the codebase root directory
        codebase_language: The language the codebase is written in
        
    Returns:
        Response from the codebase inspector agent
    """
    # Input validation
