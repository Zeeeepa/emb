...
def create_sdk_expert_agent(
    ...
    **kwargs
    ...
    Args:
       ...
       model_name: Name of the model to use (default: claude-3-5-sonnet-latest)
       model_provider: Provider of the model to use (default: anthropic)
       memory: Whether to use memory for the agent (default: True)
       debug: Whether to print agent's thought process (default: True)
    ...
    memory_instance = MemorySaver() if memory else None
