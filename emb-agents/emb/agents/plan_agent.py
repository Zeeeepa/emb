"""Plan agent implementation for the EMB framework."""
...
class PlanAgent(BaseAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent = self._create_plan_agent(
    ...
    def _create_plan_agent(
        ...
        **kwargs,
        ...
        from emb.extensions.langchain.agent import create_plan_agent
        
        return create_plan_agent(
